...
exports.buildArtifactLineageGraph = buildArtifactLineageGraph;
function buildArtifactLineageGraph(artifacts) {
    ...
    const computeDepth = (artifactId) => {
        const node = nodes[artifactId];
        if (!node || !node.parentArtifactId)
            return 0;
...
//# sourceMappingURL=artifact-lineage.js.map